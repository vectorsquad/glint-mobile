...
const passwordInvalidLengthMessage =
...
ValidatorFunc createValidator(String emptyMessage,
...
final passwordValidator = createValidator(
    "Password", [Validator(() => invalidPasswordMessage, validPassword)]);
